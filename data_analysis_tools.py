...
The floatE class
    ...
    --------------------------------------------
    Note: sometimes the ascii is printed incorrectly, the ± sign could look
    like a � sign when a floatE variable is printed. To fix this, set
    fix_ascii (line 63) to true.

Better_curve_fit() function
